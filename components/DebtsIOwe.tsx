import { getDebtsIOwe } from "@/src/api/debts";
...
const DebtsIOwe = () => {
  ...
  const fetchDebts = useCallback(async () => {
    ...
    const { data, error } = await getDebtsIOwe(userId);
  ...
  return (
    <View style={{ padding: 8, flex: 1, backgroundColor: "#101D22" }}>
      ...
      >
        ...
        <Text style={{ color: "#FB7185", fontWeight: "800", fontSize: 24 }}>
